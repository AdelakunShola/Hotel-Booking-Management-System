...
<h1 style="color:#199e59;direction:ltr;font-family:'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:74px;font-weight:700;letter-spacing:normal;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">CloudMotion Hotel<br/> </h1>
</div>
...
<div class="bee-block bee-block-1 bee-paragraph">
<p><strong>Hello Sir </strong><br/><strong>Your Booking Request has been confirmed with the following data below. </strong></p>
 ...
 <h4> Payment Method : {{ $booking['payment_method'] }}</h4>
...
<p>if you did not make this booking please let us know.</p>
</div>
