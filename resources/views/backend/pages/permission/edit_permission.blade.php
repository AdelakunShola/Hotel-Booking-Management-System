...
<div class="page-content">
    ...
    <div class="col-lg-12">
       ...
       <form  class="row g-3" action="{{ route('update.permission', ['id' => $permission->id]) }}" method="post" enctype="multipart/form-data">
         @csrf
    ...
    <div class="col-md-6">
        ...
        <select name="group_name" class="form-select mb-3" aria-label="Default select example">
            ...
            <option value="Manage Admin" {{ $permission->group_name == 'Manage Admin' ? 'selected' : '' }}>Manage Admin</option>
